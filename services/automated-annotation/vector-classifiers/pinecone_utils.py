...
- ``PINECONE_INDEX_NAME`` (optional, default: ``mfc-classifier-bags-models-userdatanamespace``)
...
DEFAULT_INDEX_NAME = os.getenv("PINECONE_INDEX_NAME", "mfc-classifier-bags-models-userdatanamespace")
